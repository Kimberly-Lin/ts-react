...
interface CreateBoxProp {
  createBox: (formData: FormWithIdInterface) => void
}
...
interface FormWithIdInterface extends FormDataInterface {
  id: string;
}

function NewBoxForm({ createBox }: CreateBoxProp): JSX.Element {
